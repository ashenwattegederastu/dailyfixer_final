...
<div class="hub-hero">
    <div class="hub-hero-content">
        ...
        <div class="hub-search-wrapper">
            <form class="hub-search-form" id="hub-search-form" action="${pageContext.request.contextPath}/guides"
...
<div class="hub-body">
    ...
    <div class="hub-category-grid">
        ...
        <%--
            ...
            <img src="${pageContext.request.contextPath}/assets/images/guides/home-repair.jpg"
                 alt="Home Repair" class="hub-cat-img">
        --%>
        ...
        <a href="${pageContext.request.contextPath}/guides?mainCategory=Home+Electronics+%2F+Appliance+Repair"
           class="hub-cat-card">
            ...
            <div class="hub-cat-body">
                ...
                <p class="hub-cat-desc">TVs, washing machines, refrigerators, and other household electronics.</p>
                <span class="hub-browse-btn primary">Browse Guides <i class="ph ph-arrow-right"></i></span>
            </div>
        </a>
        ...
        --%>
        <a href="${pageContext.request.contextPath}/guides?mainCategory=Vehicle+Repair" class="hub-cat-card">
            <div class="hub-cat-img-placeholder">
                <i class="ph ph-car"></i>
            </div>
            <div class="hub-cat-body">
                <h3 class="hub-cat-title">Vehicle Repair</h3>
                <p class="hub-cat-desc">Cars, motorcycles, tyres, engines, and roadside troubleshooting.</p>
                <span class="hub-browse-btn primary">Browse Guides <i class="ph ph-arrow-right"></i></span>
            </div>
        </a>

        <!-- ── View All ──────────────────────────────────── -->
        <a href="${pageContext.request.contextPath}/guides?viewAll=true" class="hub-cat-card hub-view-all">
            <div class="hub-cat-img-placeholder">
                <i class="ph ph-books"></i>
            </div>
            <div class="hub-cat-body">
                <h3 class="hub-cat-title">View All Guides</h3>
                <p class="hub-cat-desc">Browse the complete library of repair guides across all categories.</p>
                <span class="hub-browse-btn secondary">View All <i class="ph ph-arrow-right"></i></span>
            </div>
        </a>
